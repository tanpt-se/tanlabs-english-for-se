...
const STORAGE_KEY = '@tanlabs/grammar_completed_sessions_v1';
const MAX_SESSIONS = 20;

type StoredSessions = Record<string, CompletedPracticeSession>;
...
export async function saveCompletedSession(session: CompletedPracticeSession): Promise<void> {
