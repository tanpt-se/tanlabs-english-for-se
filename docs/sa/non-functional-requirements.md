...
| NFR-SEC-02 | Authorisation enforced by RLS for user-owned data        | M   | Delivered |
...
| NFR-REL-03 | Grammar completion writes shall be idempotent across retry/reconnect                        | M   | Delivered |
...
| NFR-PERF-02 | Practice interactions shall remain responsive after questions are loaded (local grading)    | M   | Delivered              |
...
| NFR-A11Y-04 | Grammar exercises completable with Dynamic Type / screen reader assumptions of the phase    | M   | Delivered |
| NFR-UX-01   | Loading, empty, error, and retry states must not leave blank blocking screens on core flows | M   | Delivered |
...
| NFR-OPS-05 | Representative Grammar E2E before PH2 release           | M   | Delivered (`maestro/*/smoke-grammar.yaml`) |
...
| NFR-MAINT-04 | BA/SA docs updated when scope or architecture contracts change      | S   | Delivered |
